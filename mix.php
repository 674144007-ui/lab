<?php
// mix.php - Final Version (No Formula Column)
...
try {
    ...
    // ดึงข้อมูลสารเคมี (ไม่มี formula)
    ...
    // --- 4. ตรวจสอบปฏิกิริยา (Reaction Check) ---
    ...
    echo json_encode([
        ...
        "product_formula" => "-", // Fix: ส่งค่าว่างเสมอเพราะไม่มีคอลัมน์นี้แล้ว
